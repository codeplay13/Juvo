# USAGE
# python distance_calculation_img.py --image images/acute.jpg --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel
...
for i in np.arange(0, detections.shape[2]):
	...
	if(i>0):
		...
		find_angle(centX[0], centY[0], centX[1], centY[1])
		D = int(D*0.0265)
		print(D, "Centimeters")
		D = str(D)
